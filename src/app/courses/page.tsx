    ...
    return (
        <div>
            <div className="max-w-7xl mx-auto p-4">
                ...
                <p className="mb-2">Explore our wide range of basketball courses designed to help you improve your skills on the court. Whether you are a beginner or looking to enhance your techniques, we have a program suitable for every player.</p>
